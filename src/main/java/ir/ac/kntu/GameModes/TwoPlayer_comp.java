...
public class TwoPlayer_comp extends GameMode {
    ...
    private boolean P1_Win = false, P2_Win = false;
    ...
    public void runOneCycle() {
        if (deadCycle_1 == 0 && pacman_1.isAlive()) {
            ...
            if (tile == '.') {
                ...
                --dotCount;
                if (dotCount == 0) {
                    if (pacman_1.getPoints() > pacman_2.getPoints())
                        P1_Win = true;
                    else if (pacman_2.getPoints() > pacman_1.getPoints())
                        P2_Win = true;
                    else {
                        P1_Win = true;
                        P2_Win = true;
        ...
        if (pacman_1.isAlive() && !pacman_2.isAlive())
            P1_Win = true;
        else if (!pacman_1.isAlive() && pacman_2.isAlive())
            P2_Win = true;
        else if (!pacman_1.isAlive() && !pacman_2.isAlive())
            if (pacman_1.getPoints() > pacman_2.getPoints())
                P1_Win = true;
