    ...
    public void runOneCycle() {
        ...
        if (freezeCycle == 0) {
            for (Ghost ghost : ghosts) {
                if (deadCycle == 0 && ghost.getX() == pacman.getX() && ghost.getY() == pacman.getY() && deadCycle == 0) {
                    pacman.die(Map);
                    deadCycle = 5;
                }
                if (deadCycleAI == 0 && ghost.getX() == pacman_AI.getX() && ghost.getY() == pacman_AI.getY() && deadCycleAI == 0) {
                    pacman_AI.die(Map);
                    deadCycleAI = 5;
                }
